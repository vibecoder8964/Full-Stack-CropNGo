    ...
    <div className="min-h-screen bg-cream-50 font-body text-bark-700 selection:bg-forest-500 selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-forest max-w-none text-bark-600 leading-relaxed text-lg space-y-8">
          <p>
            Welcome to AgriConnect! By accessing or using our platform, you agree to comply with and be bound by the following Terms of Service.
          </p>
          
          <div>
            <h2 className="text-2xl font-bold font-display text-bark-700 mb-4">1. Acceptance of Terms</h2>
            <p>By registering for and using AgriConnect, you acknowledge that you have read, understood, and agree to follow these Terms. If you do not agree, please do not use our services.</p>
          </div>
          ...
          <div>
            ...
            <p>AgriConnect facilitates connections but is not a party to the transactions between Farmers, Vendors, and Suppliers. We do not guarantee the quality, safety, or legality of items listed.</p>
          </div>
