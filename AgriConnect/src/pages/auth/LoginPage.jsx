      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <Link to="/" className="flex items-center gap-2 mb-10 w-fit">
            ...
            <span className="font-display font-bold text-2xl text-bark-700">AgriConnect</span>
          </Link>

          <div>
            <h1 className="font-display font-bold text-4xl text-bark-700 mb-2">Welcome back.</h1>
            <p className="text-bark-500 font-body text-base mb-8">Log in to your AgriConnect account.</p>
          </div>
