    ...
    <div className="min-h-screen bg-cream-50 font-body text-bark-700 selection:bg-forest-500 selection:text-white">
        ...
        <div className="fixed inset-0 z-[60] bg-white p-6 flex flex-col animate-fade-in">
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-xl text-bark-700">AgriConnect</span>
            </div>
      ...
      <section className="relative min-h-[100dvh] pt-32 pb-20 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center justify-center flex-1 w-full -mt-[6vh] pb-[6vh]">
          ...
          >
            AgriConnect bridges Malaysian farmers, vendors, and suppliers — creating a seamless ecosystem to buy, sell, and manage your agricultural operations all in one place.
          </p>
      ...
      <section id="roles" className="py-24 bg-cream-100 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 reveal">
            ...
            <p className="text-bark-500 font-body text-lg">Whether you are growing crops, sourcing fresh produce, or supplying the tools to make it happen, AgriConnect is built for you.</p>
          </div>
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-3xl mx-auto px-6 text-white reveal">
          ...
          <p className="font-body text-xl text-white/95 mb-10 max-w-xl mx-auto drop-shadow-md font-medium">
            Join thousands of Malaysian farmers, vendors, and suppliers on AgriConnect today. Registration is completely free.
          </p>
      ...
      <footer className="bg-cream-100 pt-16 pb-8 border-t border-cream-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex gap-4 text-bark-400">
                {/* Facebook */}
                <a href="https://www.facebook.com/agriconnectxx" target="_blank" rel="noopener noreferrer" className="hover:text-forest-600 transition-colors" aria-label="Facebook">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                {/* Instagram */}
                <a href="https://www.instagram.com/agriconnectxx" target="_blank" rel="noopener noreferrer" className="hover:text-forest-600 transition-colors" aria-label="Instagram">
                ...
                {/* X */}
                <a href="https://x.com/agriconnectxx" target="_blank" rel="noopener noreferrer" className="hover:text-forest-600 transition-colors" aria-label="X">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="pt-8 border-t border-cream-200 flex justify-center items-center gap-4 text-sm text-bark-400 font-body">
            <p className="text-center w-full">© 2025 AgriConnect. All rights reserved.</p>
          </div>
        </div>
      </footer>
