    ...
    <div className="min-h-screen bg-cream-50 font-body text-bark-700 selection:bg-forest-500 selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-forest max-w-none text-bark-600 leading-relaxed text-lg space-y-8">
          <p>
            At AgriConnect, we take your privacy seriously. This Privacy Policy explains how we collect, use, and protect your personal data when you use our platform designed for the Malaysian agricultural sector.
          </p>
          <div>
            <h2 className="text-2xl font-bold font-display text-bark-700 mb-4">1. Information We Collect</h2>
            <p>We may collect personal information such as your name, email address, phone number, location, and role (Farmer, Vendor, Supplier) when you create an account to use AgriConnect.</p>
          </div>
          ...
          <div>
            ...
            <p>If you have any questions or concerns about this policy, please contact our support team at support@agriconnect.com.my.</p>
          </div>
        </div>
      </main>
