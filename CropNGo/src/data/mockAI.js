...
export const mockAIChat = {
  Farmer: [
    { role: 'assistant', text: 'Hello Amirul! I\'m your CropNGo AI assistant. Ask me anything about farming, soil, crops, tools, or market prices.' },
  ...
  Vendor: [
    { role: 'assistant', text: 'Hello! I\'m your CropNGo AI assistant. I can help you find farmers by crop type, analyse market availability, and give price insights.' },
  ...
  Supplier: [
    { role: 'assistant', text: 'Hello! I\'m your CropNGo AI assistant. Ask me which farmers need your equipment, market trends, or how to expand your reach across Malaysia.' },
